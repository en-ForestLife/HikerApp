...
class TranslateLanguage {
  ...
  String convertedLanguageString = '';
  ...
  String getOtherLanguage() {
    //super.onInit();
    print('hello world');
    getTranslation_papago(this.languageString);
    return convertedLanguageString;
  }
...
//만약 성공적으로 언어를 받아왔다면 language 변수에 언어가 저장됩니다. (ex: eu, ko, etc..)
  ...
  Future<void> getTranslation_papago(String languageString) async {
    String _client_id = "6mZvws_z90LcqP_ZRmTS";
    String _client_secret = "dA465UlQrv";
    String _content_type = "application/x-www-form-urlencoded; charset=UTF-8";
    String _url = "https://openapi.naver.com/v1/papago/n2mt";
    ...
    if (trans.statusCode == 200) {
      ...
      print(result_papago.toString());
      convertedLanguageString = result_papago.toString();
    } else {
